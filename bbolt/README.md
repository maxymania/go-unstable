...
to implement various performance-hacks, and (possibly but not surely) features, that
are currently only found in [LMDB][lmdb].

Bolt itself is a pure Go key/value store inspired by [Howard Chu's][hyc_symas]
